...
The hypothetical error introduced by considering the unrealistic situation of adjacent extrema of Antarctic elevation in a data cell yields an error on the order of one meter.

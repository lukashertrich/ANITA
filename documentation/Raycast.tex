...
\begin{equation}\label{eqn:cos_sqr_phi}
 \cos^2{\varphi} = \frac{x_{el}^2 + y_{el}^2}{r_{el}^2} = \frac{(r_{0x} + \tau d_x)^2 + (r_{0y} + \tau d_y)^2}{R_{eq}^2 r_{el}^2}
\end{equation}
...
\begin{equation}\label{eqn:R_of_tau}
 R(\tau) = \sqrt{\frac{R_{eq}^2 \left[ (r_{0x} + \tau d_x)^2 + (r_{0y} + \tau d_y)^2 \right] + R_{po}^2 \left[ (r_{0z} + \tau d_{z})^2 \right]}{(r_{0x} + \tau d_x)^2 + (r_{0y} + \tau d_y)^2 + (r_{0z} + \tau d_{z})^2}}
\end{equation}
